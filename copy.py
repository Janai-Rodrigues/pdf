...
class IconManager:
    ...
    _svg_data = {
        ...
        "fit-width": """<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="10" y1="3" x2="10" y2="21"></line><line x1="14" y1="3" x2="14" y2="21"></line><polyline points="5 9 2 12 5 15"></polyline><polyline points="19 9 22 12 19 15"></polyline><line x1="10" y1="12" x2="2" y2="12"></line><line x1="14" y1="12" x2="22" y2="12"></line></svg>""",
        "fit-page": """<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="10" y1="3" x2="10" y2="21"></line><line x1="14" y1="3" x2="14" y2="21"></line><polyline points="6 9 9 12 6 15"></polyline><polyline points="18 9 15 12 18 15"></polyline><line x1="2" y1="12" x2="9" y2="12"></line><line x1="22" y1="12" x2="15" y2="12"></line></svg>""",
...
class PDFGraphicsView(QGraphicsView):
    ...
    single_click_selection = pyqtSignal()
...
class MainWindow(QMainWindow):
    ...
    def _toggle_visibility(self):
        ...
        # Se a janela está visível e não está minimizada, oculte-a.
        if self.isVisible() and not self.isMinimized():
            self.hide()
            logger.debug("Janela oculta pelo toggle.")
        # Se estiver oculta ou minimizada, mostre-a e traga para frente.
        else:
            self.showNormal() # Garante que saia do estado minimizado/oculto
            self.raise_()
            self.activateWindow()
            logger.debug("Janela exibida pelo toggle.")
...
def main():
    ...
    if socket.waitForConnected(500):
        ...
        def handle_new_connection():
            ...
            if new_socket:
                # Aguarda um curto período para ver se um caminho de arquivo é enviado
                if new_socket.waitForReadyRead(250):
                    file_path = new_socket.readAll().data().decode('utf-8')
                    logger.info(f"Recebido caminho de arquivo: {file_path}")
                    if os.path.exists(file_path):
                        window._add_new_tab(file_path) # Já traz a janela para frente
                    else:
                        logger.error(f"Arquivo '{file_path}' não encontrado.")
                else:
                    # Nenhum dado recebido, é um pedido para alternar a visibilidade
                    logger.info("Recebido pedido de ativação. Alternando visibilidade.")
